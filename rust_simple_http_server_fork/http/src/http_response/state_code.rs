...
impl From<HttpStateCode> for String {
    fn from(state_code: HttpStateCode) -> Self {
        match state_code {
            ...
            HttpStateCode::StatusProxyAuthRequired => "Proxy Authentication Required".to_string(),
            ...
            HttpStateCode::StatusRequestEntityTooLarge => "Request Entity Too Large".to_string(),
